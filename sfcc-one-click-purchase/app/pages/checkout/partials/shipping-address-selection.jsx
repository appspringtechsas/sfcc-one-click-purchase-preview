...
import {shallowEquals} from '@appspringtechsas/sfcc-one-click-purchase/app/utils/utils'
import {RadioCard, RadioCardGroup} from '@appspringtechsas/sfcc-one-click-purchase/app/components/radio-card'
import ActionCard from '@appspringtechsas/sfcc-one-click-purchase/app/components/action-card'
import {PlusIcon} from '@appspringtechsas/sfcc-one-click-purchase/app/components/icons'
import AddressDisplay from '@appspringtechsas/sfcc-one-click-purchase/app/components/address-display'
import AddressFields from '@appspringtechsas/sfcc-one-click-purchase/app/components/forms/address-fields'
import FormActionButtons from '@appspringtechsas/sfcc-one-click-purchase/app/components/forms/form-action-buttons'
import {MESSAGE_PROPTYPE} from '@appspringtechsas/sfcc-one-click-purchase/app/utils/locale'
import {useCurrentCustomer} from '@appspringtechsas/sfcc-one-click-purchase/app/hooks/use-current-customer'
                    ...
                    <Box pt={2}>
                        <Container variant="form">
                            <Button
                                ...
                                className='one-click-checkout-submit-shipping-address'
                            >
                                {formatMessage(submitButtonLabel)}
                            </Button>
                        </Container>
