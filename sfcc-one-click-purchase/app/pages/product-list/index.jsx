...
import {
    ...
    DrawerContent,
    DrawerCloseButton
} from '@appspringtechsas/sfcc-one-click-purchase/app/components/shared/ui'

// Project Components
import Pagination from '@appspringtechsas/sfcc-one-click-purchase/app/components/pagination'
import ProductTile, {
    Skeleton as ProductTileSkeleton
} from '@appspringtechsas/sfcc-one-click-purchase/app/components/product-tile'
import {HideOnDesktop} from '@appspringtechsas/sfcc-one-click-purchase/app/components/responsive'
import Refinements from '@appspringtechsas/sfcc-one-click-purchase/app/pages/product-list/partials/refinements'
import SelectedRefinements from '@appspringtechsas/sfcc-one-click-purchase/app/pages/product-list/partials/selected-refinements'
import EmptySearchResults from '@appspringtechsas/sfcc-one-click-purchase/app/pages/product-list/partials/empty-results'
import PageHeader from '@appspringtechsas/sfcc-one-click-purchase/app/pages/product-list/partials/page-header'
import AbovePageHeader from '@appspringtechsas/sfcc-one-click-purchase/app/pages/product-list/partials/above-page-header'

// Icons
import {FilterIcon, ChevronDownIcon} from '@appspringtechsas/sfcc-one-click-purchase/app/components/icons'
...
import {
    ...
    useSortUrls,
    useSearchParams
} from '@appspringtechsas/sfcc-one-click-purchase/app/hooks'
import {useToast} from '@appspringtechsas/sfcc-one-click-purchase/app/hooks/use-toast'
import useEinstein from '@appspringtechsas/sfcc-one-click-purchase/app/hooks/use-einstein'
import useActiveData from '@appspringtechsas/sfcc-one-click-purchase/app/hooks/use-active-data'
...
} from '@appspringtechsas/sfcc-one-click-purchase/app/constants'
import useNavigation from '@appspringtechsas/sfcc-one-click-purchase/app/hooks/use-navigation'
import LoadingSpinner from '@appspringtechsas/sfcc-one-click-purchase/app/components/loading-spinner'
import {useWishList} from '@appspringtechsas/sfcc-one-click-purchase/app/hooks/use-wish-list'
import {isHydrated} from '@appspringtechsas/sfcc-one-click-purchase/app/utils/utils'
import OneClickPurchaseCheckoutContainer from '@appspringtechsas/sfcc-one-click-purchase/app/components/one-click-purchase-checkout/index'
...
const ProductList = (props) => {
    ...
    return (
        <>
            <OneClickPurchaseCheckoutContainer />
            <Box
